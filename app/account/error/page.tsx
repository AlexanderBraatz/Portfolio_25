		...
		>
			<div className="w-full flex flex-row justify-center mb-6">
				<div className=" flex justify-center items-center h-24 w-24 rounded-full object-cover border-[0.35rem] border-white bg-slate-100 shadow-xl">
					<BiErrorAltIcon className="opacity-70 w-12 h-12" />
				</div>
			</div>
			...
			<div className="flex gap-1 flex-col justify-center items-center h-5 ">
				<p className="text-gray-700 ">Please send a screenshot to Alex.</p>
				<p className="text-gray-700 ">He will be very glad to fix this ASAP.</p>
			</div>
		</motion.div>
	);
}
